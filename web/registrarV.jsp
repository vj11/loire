<%-- 
    Document   : registrarV'
    Created on : 04-oct-2019, 12:16:14
    Author     : sakur
--%>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Registar Vehiculo</h4>
                  <p class="card-category">Registar Vehiculo</p>
                </div>
                <div class="card-body">
        <form method="post" action="servlet2">
            ...
            <%
             ...
             <label class="bmd-label-floating" required>Conductor a Cargo</label>
