            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Registrar Mantenimiento</h4>
                  <p class="card-category"> Registrar Mantenimiento</p>
                </div>
                <div class="card-body">
          ...
          <jsp:useBean id="cn" class="modeloDAO.manteDAO" scope="page"></jsp:useBean>
              <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <textarea class="form-control" id="daños" rows="3" name="danos"></textarea>
                  </div>
                  <div class="form-group col-md-6">
                      ...
                      <div class="form-row">
                  <div class="form-group col-md-6">
                      <label  class="bmd-label-floating">costo de repuestos</label>
                      <input type="number" class="form-control" id="costosre" name="costosre" value="" >
                  </div>
                   <div class="form-group col-md-6">
                      <label class="bmd-label-floating">costo de revision</label>
              ...
              <div class="form-row">
                  <div class="form-group col-md-6">
                      <label  class="bmd-label-floating">Coductor a cargo</label>
                      <select class="form-control" name="idconductor" id="idconductor">
                          ...
                          <option value="<%=rs.getInt("idSolicitud")%>"><%=rs.getString("primerNombre")%></option>
                          <%
                              }
                          %>
                      </select>
              ...
              <input type="submit" class="btn btn-primary"  name="accion" onclick="validar()" value="registrar"><br><br>
  ...
  <div class="fixed-plugin">
    <div class="dropdown show-dropdown">
      ...
      <ul class="dropdown-menu">
        <li class="header-title"> Filtros de la barra lateral</li>
