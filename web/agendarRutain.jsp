            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">schedule a route</h4>
                  <p class="card-category">schedule a route</p>
                </div>
                <div class="card-body">
             ...
             %>
                 ...
                 %>
                    ...
                    <input type="submit" class="btn btn-primary pull-right"  name="accion" onclick="validar()" value="add">
