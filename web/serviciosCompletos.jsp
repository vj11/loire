<%-- 
    ...
    Created on : 04-oct-2019, 12:17:17
    Author     : sakur
--%>
...
Service Completed
  ...
  <!-- CSS Files -->
  <link href<link href="assets/css/material-dashboard.css?v=2.1.1" rel="stylesheet" />
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="mantein.jsp">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Services Completed</h4>
                  <p class="card-category">Services Completed</p>
                </div>
                <div class="card-body">
        <div class="table-responsive">
                
                <table class="table" id="dt1 example">
<thead class=" text-primary">
                  <tr>
                    <th class="text-center"># servicio</th>
                            ...
                            <th class="text-center">Mensage</th>
                  ...
                  <tr>
                    <th class="text-center"># servicio</th>
                            ...
                            <% ClienteDAO dao = new ClienteDAO();
                             List<Cliente> list = dao.listarCompletos();
                            ...
                            %>
                             ...
                             <td style="display: none"><%= cl.getEmail()%></td>

                            <td>
                   <a class="btn btn-warning" href="ServletCliente?accion=editar&idcliente=<%= cl.getIdCliente()%><i class="material-icons">edit</i></a>
                   <a class="btn btn-success" onClick="mensaje1()"><i class="material-icons">insert_drive_file</i></a>
                   <a class="btn btn-danger" onClick="mensaje()"><i class="material-icons">insert_drive_file</i></a></td>
                    <script>
                   function mensaje() {
                     Swal.fire({
                     title: '¿Deseas generar una factura de este servicio?',
                     type: 'warning',
                     showCancelButton: true,
                     confirmButtonColor: '#3085d6',
                     cancelButtonColor: '#d33',
                     confirmButtonText: 'Si, deseo generarla.'
  
                      }).then((result) => {
                     if (result.value) {
                    location.href="ServletCliente?accion=Generar&idcliente=<%=cl.getPersona_IdPersona()%>&email=<%= cl.getEmail()%>";
                          }
                        })
                       }
                     </script>
                   ...
                   function mensaje1() {
                     Swal.fire({
                     title: '¿Deseas generar un acta de este servicio?',
                     type: 'warning',
                     showCancelButton: true,
                     confirmButtonColor: '#3085d6',
                     cancelButtonColor: '#d33',
                     ...
                     if (result.value) {
                    location.href="ServletCliente?accion=Generaracta&idcliente=<%= cl.getPersona_IdPersona()%>&email=<%= cl.getEmail()%>";
                          }
                        })
                       }
                     </script>
...
<script>
  ...
  $('#csv').on('click',function(){
    $("#example").tableHTMLExport({type:'csv',filename:'services.csv'});
  })
  $('#pdf').on('click',function(){
    $("#example").tableHTMLExport({type:'pdf',filename:'services.pdf'});
  })
  </script>   
            </div>
   <footer class="footer">
