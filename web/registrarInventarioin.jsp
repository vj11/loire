  ...
  <div class="wrapper ">
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">register inventory</h4>
                  <p class="card-category">register inventory</p>
                </div>
                <div class="card-body">
    ...
    <div class="form-row">
           ...
           <input type="number" class="form-control" id="idForm" name="idform"  value="" required>
            ...
            <div class="form-group col-md-6">
             <label class="bmd-label-floating" required>waste organic type</label>
      ...
      <div class="form-row">
         <div class="form-group col-md-6">
           ...
           <input type="number" class="form-control" id="cantidad" name="cantidad" value="" required>
            ...
            <input type="submit" class="btn btn-primary pull-right"  name="accion" onclick="validar()" value="add"><br><br>
