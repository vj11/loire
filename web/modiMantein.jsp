            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">update maintenance</h4>
                  <p class="card-category">update maintenance</p>
                </div>
                <div class="card-body">
             ...
             <select class="form-control" name="idVehiculo" id="idVehiculo">
              ...
              <option value="proceso">in process</option>
              <option value="inactivo">Inactive</option>
                    ...
                    <input type="submit" class="btn btn-primary pull-right"  name="accion" onclick="validar()" value="edit">
