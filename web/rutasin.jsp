    ...
    <div class="main-panel">
      ...
      <div class="content">
        ...
        <div class="table-responsive">
               ...
               <button type="button" class="btn btn-outline-secondary"><a href="agendarRutain.jsp">Schedule a new route</a></button>
            </div>
   <footer class="footer">
        <div class="container-fluid">
     ...
     <script>
            function mensaje(id) {
                Swal.fire({
                    ...
                    if (result.value) {
                    location.href="servlet3?accion=delete&id="+id;
                    }
                })
            }</script>
  <!--   Core JS Files   -->
