  ...
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
          ...
          <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item">
            <a class="nav-link" href="cliente.html" >Solicitud Servicio</a>
            
            </li>
           <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Notificaciones</a>
            <div class="dropdown-menu">
                   <a class="nav-link dropdown-item"href="html/index-estado.html">Recolección de Residuos</a>
                  <a class="nav-link dropdown-item" href="html/index-estado1.html">Disposición de Residuos</a>
            </div>
            </li>
            <li class="nav-item">
        ...
        <ul class="navbar-nav ml-auto mt-2 mt-lg-0  col-sm-3">         
          <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Cliente<br>${nombreUsuario}</a>
          <div class="dropdown-menu">
       ...
       <div class="login__top">
           <h2 class="login__title">SOLICITUD <span> SERVICIO</span></h2>
       </div>
        <form class="login__form">
              ...
              <br>                    
               ...
               <textarea name="message" class="form-control" id="comentario" cols="30" rows="10" placeholder="Debes introducir un texto menor a 300 caracteres"  maxlength="300"/></textarea>
               <br> 
              <br>
