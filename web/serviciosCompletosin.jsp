    ...
    <div class="main-panel">
      ...
      <div class="content">
        ...
        <div class="table-responsive">
            <jsp:useBean id="cn" class="modeloDAO.reportesDAO" scope="page"></jsp:useBean>
...
<thead class=" text-primary">
                  <tr>
                    <th class="text-center"># service</th>
                            ...
                            <th class="text-center">date service</th>
                ...
                <tfoot>
                  <tr>
                   ...
                   <a class="btn btn-warning" href="ServletCliente?accion=modify&idcliente=<%= cl.getIdCliente()%>"><i class="fas fa-edit"></i></a>
                   <center><button class="btn btn-danger" onClick="mensaje()"><i class="fas fa-file-alt"></i></button></center></td>
                   ...
                   function mensaje() {
                     ...
                     if (result.value) {
                    location.href="ServletCliente?accion=Generar&idcliente=<%= cl.getPersona_IdPersona()%>";
                          }
                        })
                       }
                     </script>
